 ...
 * clase padre (Casta), pasándole los argumentos recibidos por el constructor hijo.
 */
public class Hechicero extends Casta {
	 ...
	 * padre (Casta), inicializando probabilidadGolpeCritico, probabilidadEvitarDaño,
	 ...
	 * se retornará false. El parámetro caster a su vez llama al método
	 * calcularPuntosDeMagia() el cual luego se multiplica por 1.5
	 * @param caster
	 ...
	 * atacante(caster) posea 10 o más del atributo energia ya que estos se descuentan
	 * seguido de comprobar que los posee, de lo contrario el ataque no será posible y
	 * se retornará false. Para que éste método tenga posibilidad de retornar true,
	 * aliado debe ser de la instancia Personaje
	 * @param caster
	 *            Personaje que realiza la habilidad
	 * @param aliado
	 ...
	 * atacante(caster) posea 10 o más del atributo energia ya que estos se descuentan
	 * seguido de comprobar que los posee, de lo contrario el ataque no será posible y
	 * se retornará false. Para que éste método tenga posibilidad de retornar true, el
	 * Atacado debe ser una instancia Personaje
	 * @param caster
	 *            Personaje que realiza la habilidad
	 * @param atacado
	 *            El atacado puede ser una instancia de Persona o NPC dependiendo de la
	 *            misma podrá o no retornar true el método.
