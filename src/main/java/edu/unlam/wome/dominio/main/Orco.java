...
public class Orco extends Personaje {
	 ...
	 * se retornará false El método serAtacado() tiene como argumento el doble del
	 * valor del atributo defensa del llamador
	 * @param atacado
	 ...
	 * atacante(caster) posea 10 o más del atributo energia ya que estos se descuentan
	 * seguido de comprobar que los posee, de lo contrario el ataque no será posible y
	 * se retornará false El método serAtacado() tiene como argumento el valor del atributo
	 * fuerza del llamador luego el llamador se cura con el daño causado al atacado
	 * @param atacado
	 *            Instancia de Personaje o de NPC, dependiendo de cual sea,
	 *            será como responda el método serAtacado()
	 * @return Retorna si el ataque fue exitoso o no.
